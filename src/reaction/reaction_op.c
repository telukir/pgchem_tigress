...
inline static Datum rss_match(REACTION *query, REACTION *predicate)
{
    ...
    int i,j,m=0;
    int match;
    int16 q_num_products = query->num_products;
    int16 q_num_reactants = query->num_reactants;
    int16 p_num_products = predicate->num_products;
    int16 p_num_reactants = predicate->num_reactants;
